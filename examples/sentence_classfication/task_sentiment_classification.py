...
maxlen = 256
batch_size = 16
config_path = '/home/wzl/project/kbner/resources/taggers/mlee_pretune4/bert-base-uncased/config.json'
checkpoint_path = '/home/wzl/project/kbner/resources/taggers/mlee_pretune4/bert-base-uncased/pytorch_model.bin'
dict_path = '/home/wzl/project/kbner/resources/taggers/mlee_pretune4/bert-base-uncased/vocab.txt'
...
# 加载数据集
train_dataloader = DataLoader(MyDataset(['/home/wzl/project/kbner/kb/datasets/iron/trian.txt']), batch_size=batch_size, shuffle=True, collate_fn=collate_fn)
valid_dataloader = DataLoader(MyDataset(['/home/wzl/project/kbner/kb/datasets/iron/dev.txt']), batch_size=batch_size, collate_fn=collate_fn)
test_dataloader = DataLoader(MyDataset(['/home/wzl/project/kbner/kb/datasets/iron/test.txt']),  batch_size=batch_size, collate_fn=collate_fn)
